...
Also, for anyone interested, there is a [CONTRIBUTING.md](https://github.com/PaulHBartley/mkproj/blob/main/CONTRIBUTING.md) page with some ideas for how this project could take shape in the future.
