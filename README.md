...
`$ mkrepo`  <-- child #2  
 <br>  
The parent function, `$ mkproj`, relies on its two child functions to operate. The child functions, on the other hand, can operate independently. How convenient.
<br>  
