...
The scripts should work in other bash 5.0+ environments (assuming Python 3.6+ is installed), but until further testing is done, users are advised to test these scripts with caution. If any problems are found, please don't hesitate to open an issue.
